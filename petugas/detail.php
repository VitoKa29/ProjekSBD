...
<form method = "POST" class="form-horizontal" style="margin-left:7%;margin-right:10%;margin-top:5%;"  enctype = "multipart/form-data">
                ...
                <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="<?php echo $data["nik"]; ?>" class="form-control" disabled>
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="<?php 
                        $sql = mysql_query(" SELECT * FROM masyarakat WHERE nik = '$data[nik]' ");
                  ...
                  <a href="laporan.php?id=<?php echo $data['id_pengaduan']; ?>" class="btn btn-primary" style="margin-left:83%; margin-top:2%;">Print Pengaduan</a>
                </div>
