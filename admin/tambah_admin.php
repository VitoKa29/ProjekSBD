...
<form method = "POST" class="form-horizontal"  action = "crud.php?aksi=tambah_admin" style="margin-left:7%;margin-right:10%;margin-top:5%;"  enctype = "multipart/form-data">
                <div class="card-body">
                ...
                <!-- /.card-body -->
                  ...
                  <input type="submit" value="Tambah Admin" name="kirim" class="btn btn-primary" style="margin-left:84%; margin-top:2%;">
