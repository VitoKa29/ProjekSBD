...
?>
<center><h1>Tanggapan Laporan Selesai</h1></center>
<form method = "POST" action="crud.php?aksi=selesai" class="form-horizontal" style="margin-left:7%;margin-right:10%;margin-top:5%;"  enctype = "multipart/form-data">
<input type="hidden" name="id" value="<?php echo $data["id_pengaduan"]; ?>">    
            <div class="card-body">
                <div class="form-group row">
                  ...
                  <input type="submit" value="Selesaikan Pengaduan" name="kirim" class="btn btn-primary" style="margin-left:80%; margin-top:2%;">
